            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        },
                        {
                            "type": "text",
                            "text": """
                            Extract the nutritional information from this label image. 
                            Return ONLY a JSON object with the following fields:
                            - "Protein": Amount of protein (e.g., "10")
                            - "Sodium": Amount of sodium (e.g., "200")
                            - "Potassium": Amount of potassium (e.g., "300")
                            - "Phosphorus": Amount of phosphorus (e.g., "150")
                            - "Sugar": Amount of sugar (e.g., "5")
                            - "Calories": Amount of calories (e.g., "150")
                            - "Total Fat": Amount of total fat (e.g., "8")
                            - "Fiber": Amount of fiber (e.g., "2")

                            If any field is missing, use "Unknown" for that field.
